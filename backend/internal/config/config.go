...
type GatewayConfig struct {
	...
	// CodexMultiAgentV2Enabled: 是否为官方 Codex 客户端启用 Responses API multi-agent v2 兼容处理。
	// 默认关闭，仅在确认上游/客户端需要时开启，避免改写其他 Responses 客户端的工具协议。
	CodexMultiAgentV2Enabled bool `mapstructure:"codex_multi_agent_v2_enabled"`
...
func setDefaults() {
	...
	viper.SetDefault("gateway.codex_multi_agent_v2_enabled", false)
